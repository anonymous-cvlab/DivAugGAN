...
class TrainOptions():
  def __init__(self):
    ...
    # # diversity-sensitive loss training related
    # self.parser.add_argument('--margin', action='store_true', help="Use margin to clip the diversity sensitive regularizer loss or not")
    # self.parser.add_argument('--margin_value', type=float, default=10, help="Margin clip value")
    # self.parser.add_argument('--lambda_diversity_sensitive', type=float, default=8.0, help="# weigghts of diversity sensitive regularizer loss")
...
class TestOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--k', type=int, default=3, help='Batch size to use')
    self.parser.add_argument('--nearest_k', type=int, default=5, help='nearest_k value')
    self.parser.add_argument('--prdc_num_samples', type=int, default=15000, help='number of samples to use for Precision & Recall, and Density & Coverage computation')
